...
std::string Helper::getValueName(Value *v) {                   
  if(!v->hasName()){                                      
...
std::string Helper::getValueType(Value *v) {                   
  if(Instruction *inst = dyn_cast<Instruction>(v)){       
    return std::string(inst->getOpcodeName());                 
  } else {                                                
    return std::string("value " + std::to_string(v->getValueID())); 
  }                                                       
}                                                         
                                                          
std::string Helper::getValueRepr(Value *v) {                   
  std::string str;                                             
...
std::string Helper::getCtypeRepr(Type *t) {                    
  std::string str;                                             
  raw_string_ostream stm(str);                            
...
void Helper::convertDotInName(std::string &name) {             
